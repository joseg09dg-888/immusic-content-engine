"""Convierte docs/libro/estrategia_email_artistas_afiliados.md a un .docx con
identidad de marca IM Music — estrategia de outreach a managers de artistas."""
import re
...
MD_PATH = ROOT / "docs" / "libro" / "estrategia_email_artistas_afiliados.md"
OUT_PATH = ROOT / "docs" / "libro" / "Estrategia_Email_Artistas_Afiliados_IM_Music.docx"
...
def build_cover(doc):
    ...
    r2 = p2.add_run("Documento interno — Estrategia de outreach a artistas/managers")
    r2.font.size = Pt(11)
    r2.italic = True
