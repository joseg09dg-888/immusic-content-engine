...
class Config:
    ...
    INSTAGRAM_USERNAME: str = _optional("INSTAGRAM_USERNAME", "immusicsello")
    INSTAGRAM_PASSWORD: str = _optional("INSTAGRAM_PASSWORD")
    INSTAGRAM_USER_ID: str = _optional("INSTAGRAM_USER_ID", "52751998133")
    META_ACCESS_TOKEN: str = _optional("META_ACCESS_TOKEN")
    META_INSTAGRAM_ACCOUNT_ID: str = _optional("META_INSTAGRAM_ACCOUNT_ID")
